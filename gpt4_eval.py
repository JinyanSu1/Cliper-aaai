...
def parse_arguments():
    ...
    parser.add_argument('--dataset_dir', type=str, default = 'eval_generations/baselines/classifier_guided', help="Directory containing dataset files.")
    parser.add_argument('--reward_model_base_path', type=str, default = 'data_process/reward_models', help="Base path for reward models.")
    parser.add_argument('--prompt_dir', type=str, default='pref_prompt', help="Directory containing prompt files.")
    ...
    parser.add_argument('--cache_dir', type=str, default = 'cache', help="Directory for caching models.")
    parser.add_argument('--baseline_path', type=str, default = "eval_generations/baselines", help="Path to baseline files.")
    ...
    parser.add_argument('--output_file', type=str, default = 'eval_generations/output/', help="Path to store final results.")
