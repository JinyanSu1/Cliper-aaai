...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='classifier/data/processed/top1',
    ...
    parser.add_argument('--finalmodel_dir', type=str, default='./models/classifier/final_model',
                        help="Directory for saving the final model")
    parser.add_argument('--result_dir', type=str, default='./models/classifier/result', help="result_dir")
