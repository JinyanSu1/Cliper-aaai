...
import os
os.environ['HF_HOME'] = '/share/nikola/js3673/cache'
...
def get_args():
    ...
    parser.add_argument("--dataset_name", type=str, default="/share/nikola/js3673/project/personalized_alignment/data/alpaca_gpt4_10k.json")
    parser.add_argument("--start_per", type=int, default=0)
    parser.add_argument("--end_per", type=int, default=100)
    parser.add_argument("--output_dir", type=str, default="/share/nikola/js3673/project/personalized_alignment/Classifier-Guided/data")
