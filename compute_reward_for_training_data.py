...
def parse_args():
    ...
    # Add arguments
    parser.add_argument('--data_dir', type=str, default='/share/nikola/js3673/project/personalized_alignment/Classifier-Guided/data',
                        help='Directory containing the data')
    parser.add_argument('--reward_model_dir', type=str, default='/share/nikola/js3673/project/personalized_alignment/Classifier-Guided/data_process/reward_models', help='Directory containing reward models')
    parser.add_argument('--output_dir', type=str, default='/share/nikola/js3673/project/personalized_alignment/Classifier-Guided/data/processed_data', help='Directory to store results with rewards')
