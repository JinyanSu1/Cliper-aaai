...
def parse_arguments():
    ...
    parser.add_argument('--dataset_dir', type=str, default = 'baselines/classifier_guided', help="Directory containing dataset files.")
    ...
    parser.add_argument('--baseline_path', type=str, default = "baselines", help="Path to baseline files.")
